...
namespace PetAI
{
    public class EntityBehaviorInterpolateMount : EntityBehavior, IRenderer
    {
        ...
        public EntityBehaviorInterpolateMount(Entity entity) : base(entity)
        {
        ...
        public void OnRenderFrame(float deltaTime, EnumRenderStage stage)
        {
            ...
            float interval = (entity as EntityMount).rider == null ? 0.2f : 0.4f;
            accum += deltaTime;
            ...
            (entity as EntityMount)?.rider?.Pos.SetPos((entity as EntityMount).MountPosition);
